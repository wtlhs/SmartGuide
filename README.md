...
- ✅ **图文并茂** - 支持图片和富文本内容
- ✅ **图片轮播** - 单个引导步骤支持多图轮播展示
- ✅ **GIF动图支持** - 支持GIF动态演示，提升交互体验
- ✅ **帮助按钮** - 随时重新查看引导
- ✅ **零依赖问题** - 使用 driver.js，无 CSP 问题
- ✅ **响应式设计** - 自适应位置，智能滚动，不会超出视口
...
1. **访问首页** - 自动弹出 5 步引导
2. **体验图片轮播** - 第一步引导支持多图自动轮播
3. **查看GIF演示** - 第二步引导展示GIF动图
4. **完成引导** - 点击"下一步"或关闭按钮
5. **刷新页面** - 不再自动弹出
6. **点击"帮助"按钮** - 随时重新查看
7. **访问"关于"页面** - 体验不同的引导
